...
it. The shared class is production batch code (multi-GPU, bf16, a deliberate
...
capability >= 7.5 (Turing+); Pascal-class cards are CC 6.1. NF4 requires
only CC >= 6.0.
...
class QuantizedQwen3VLEmbedder(Qwen3VLEmbedder):
    ...
    text path and the batch pipeline is entirely untouched.
    """
