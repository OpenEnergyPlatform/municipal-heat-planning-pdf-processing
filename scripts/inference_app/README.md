...
bitsandbytes `LLM.int8()` requires compute capability ≥ 7.5 (Turing+); Pascal-class cards
...
#    land under data/. Page numbers come from the DB — no JSON needed.
...
Deploy edits from the repo by copying the files over,
