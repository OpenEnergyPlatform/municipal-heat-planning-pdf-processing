...
(`fields.py:212-235`), written directly in `runner.py:2981-2994`, not
...
(`docpipe/extraction/runner.py:2868`). The two the sweep skips are kept
...
(`docpipe/extraction/runner.py:3030`). The same split holds past the
