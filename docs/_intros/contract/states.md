...
(`fields.py:212-235`), written directly in `runner.py:2977-2990`, not
...
(`docpipe/extraction/runner.py:2864`). The two the sweep skips are kept
...
(`docpipe/extraction/runner.py:3026`). The same split holds past the
