...
(`fields.py:212-235`), written directly in `runner.py:3212-3225`, not
...
(`docpipe/extraction/runner.py:3076`). The two the sweep skips are kept
...
(`docpipe/extraction/runner.py:3262`). The same split holds past the
