...
133 modules under `docpipe/`, `profiles/`, `scripts/`, one page each, generated by `scripts/build_docs.py`.
...
- [docpipe.extraction.runner](docpipe.extraction.runner.md): Wires the pure harvest loop of `pipeline.py` to the live stack. (1 class, 59 functions)
