...
134 modules under `docpipe/`, `profiles/`, `scripts/`, one page each, generated by `scripts/build_docs.py`.
...
- [docpipe.extraction.runner](docpipe.extraction.runner.md): Wires the pure harvest loop of `pipeline.py` to the live stack. (1 class, 60 functions)
...
- [scripts.harvest_lists](scripts.harvest_lists.md): Two lists a corpus run leaves for a curator to check. (8 functions)
