...
131 modules under `docpipe/`, `profiles/`, `scripts/`, one page each, generated by `scripts/build_docs.py`.
...
- [docpipe.extraction.runner](docpipe.extraction.runner.md): Wires the pure harvest loop of `pipeline.py` to the live stack. (56 functions)
...
- [profiles.scenarios.vocabulary](profiles.scenarios.vocabulary.md): This profile's half of the ontology snapshot. (10 functions)

## scripts

- [scripts.build_docs](scripts.build_docs.md): Generate the documentation pages from the sources they describe. (1 class, 30 functions)
- [scripts.change_audit](scripts.change_audit.md): What this change touches that is not in the files it changes. (5 functions)
- [scripts.curation_list](scripts.curation_list.md): The values a person should look at, and where to look. (4 functions)
- [scripts.harvest_compare](scripts.harvest_compare.md): What a harvest is worth, without a GPU. (6 functions)
...
- [scripts.preflight_profiles](scripts.preflight_profiles.md): Both profiles, everything a corpus run rests on. (4 functions)
- [scripts.trace_report](scripts.trace_report.md): The four questions a run must be able to answer afterwards. (4 functions)

## scripts.annotation

- [scripts.annotation](scripts.annotation.md): Layout-annotation workspace: sample pages, correct pre-annotations, evaluate.
- [scripts.annotation.common](scripts.annotation.common.md): Shared class metadata + YOLO label IO for the annotation workspace. (3 functions)
- [scripts.annotation.editor](scripts.annotation.editor.md): Local web editor for correcting the layout pre-annotations. (4 classes, 4 functions)
- [scripts.annotation.evaluate](scripts.annotation.evaluate.md): Score the pre-annotations against the corrected ground truth, export COCO. (6 functions)
- [scripts.annotation.sample_and_preannotate](scripts.annotation.sample_and_preannotate.md): Build an annotation workspace: N random corpus pages, pre-annotated. (3 functions)
