<context>
Document type: Publication behind the IPCC AR6 scenario database (journal article or agency report)
...
Step 2 — Convert the table into a Markdown table:
  ...
  - Preserve all numbers, units, abbreviations, and English text verbatim.
