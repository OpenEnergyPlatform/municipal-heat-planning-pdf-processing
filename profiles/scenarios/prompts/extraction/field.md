...
Die Werte stehen fest. Du fügst keine hinzu und lässt keine weg. Gefragt ist in dieser Anfrage GENAU EIN Feld, und du beantwortest und belegst es für jeden Wert.
...
- "fields": das gesuchte Feld, als Liste mit genau einem Eintrag: "name", die Frage ("question") und, wenn es eine geschlossene Liste gibt, die zulässigen Einträge ("options": je Eintrag ein Name und die Schreibweisen, unter denen er vorkommt).
