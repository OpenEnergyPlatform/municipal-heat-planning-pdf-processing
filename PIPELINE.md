...
Dabei nutzen wir aktuellste open LLMs, DeepLearning-Modelle sowie RAG-Strategien. Alle KI-Modelle laufen lokal – die LLM- und Vision-Language-Stufen über **vLLM** (OpenAI-kompatibler Server, Continuous Batching), das Embedding direkt über HuggingFace Transformers.
